...
namespace Gamesim.Tests.EditMode
{
    ...
    public sealed class PersistenceV9MigrationTests
    {
        ...
        public void AV8SaveOnDiskLoadsUnchangedAndOnlyRewritesOnAnExplicitSave()
        {
            ...
            Assert.That(message, Does.Contain("Schema 8").And.Contain("schema 11 in memory"));
        ...
        {
            var payload = PersistenceMigrationTests.StripSchema9(PersistenceMigrationTests.StripSchema10(PersistenceMigrationTests.StripSchema11(Capture(state))));
