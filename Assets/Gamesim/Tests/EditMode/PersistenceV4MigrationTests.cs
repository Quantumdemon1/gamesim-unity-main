...
namespace Gamesim.Tests.EditMode
{
    public sealed class PersistenceV4MigrationTests
    {
        ...
        public void V3LoadAndRecoveryStayReadOnlyUntilExplicitSchema6Save()
        {
            ...
            Assert.That(message, Does.Contain("Schema 3").And.Contain("schema 10 in memory"));
            ...
            Assert.That((int)JObject.Parse(File.ReadAllText(files.Store.SavePath))["state"]["schemaVersion"], Is.EqualTo(10));
        ...
        public void MalformedVersionsAndStudyValuesRejectWithoutRewritingFiles(string damage)
        {
            ...
            else if (damage == "future-schema") payload["schemaVersion"] = 11;  // Ten is current.
