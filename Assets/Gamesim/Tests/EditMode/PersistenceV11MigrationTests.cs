...
namespace Gamesim.Tests.EditMode
{
    ...
    public sealed class PersistenceV11MigrationTests
    {
        ...
        public void AV10SaveOnDiskLoadsUnchangedAndOnlyRewritesOnAnExplicitSave()
        {
            ...
            Assert.That(message, Does.Contain("Schema 10").And.Contain("schema 11 in memory"));
        ...
        public void ThePreviousVersionsDealsSurviveTheUpgrade()
        {
            ...
            var upgraded = EpisodeSaveMigrations.UpgradeV10ToV11(payload);
            var parsed = upgraded.ToObject<EpisodeState>(Serializer());
        ...
        {
            var payload = PersistenceMigrationTests.StripSchema11(Capture(state));
