...
namespace Gamesim.Tests.EditMode
{
    ...
    public sealed class PersistenceV8MigrationTests
    {
        ...
        {
            Assert.That(ContentCatalog.Create(11u).schemaVersion, Is.EqualTo(10));
            Assert.That(SeasonBuilder.Create(new SeasonBuilder.Choice(), 11u).schemaVersion, Is.EqualTo(10));
        }
        ...
        public void AV7SaveOnDiskLoadsUnchangedAndOnlyRewritesOnAnExplicitSave()
        {
            ...
            Assert.That(message, Does.Contain("Schema 7").And.Contain("schema 10 in memory"));
        ...
        {
            var payload = PersistenceMigrationTests.StripSchema8(PersistenceMigrationTests.StripSchema9(PersistenceMigrationTests.StripSchema10(Capture(state))));
