...
namespace Gamesim.Tests.EditMode
{
    public sealed class PersistenceV6MigrationTests
    {
        ...
        {
            var result = PersistenceMigrationTests.StripCardCopy(PersistenceMigrationTests.StripSchema8(PersistenceMigrationTests.StripSchema9(PersistenceMigrationTests.StripSchema10(PersistenceMigrationTests.StripSchema11(PersistenceMigrationTests.StripSchema12(Capture(state)))))));
