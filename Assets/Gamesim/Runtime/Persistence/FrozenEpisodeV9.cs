...
{
    /// <summary>
    /// Recursive schema-9 persistence shape, frozen the moment schema 10 was cut.
    ///
    /// <para>Schema 9 is v8 plus one integer: <c>socialBudgetRulesStartWeek</c>, the boundary that
    /// let the social-action allowance change from a flat eighteen to half the active house without
    /// retroactively overspending a season already in progress.</para>
    ///
    /// <para>The bounds are v8's, and v8's were v7's. What a v9 save may <i>hold</i> never changed —
    ...
    /// </summary>
    internal static class FrozenEpisodeV9
    {
...
#pragma warning restore 0649
        ...
        {
            if (original == null || original["schemaVersion"]?.Type != JTokenType.Integer || (long)original["schemaVersion"] != 9)
                throw new InvalidDataException("Expected simulation schema version 9.");
        ...
        internal static void ValidateScalarRanges(State s)
        {
            ...
            // Schema 8's own fields, bounded at what v8 accepted.
            ...
            // Schema 9's only addition. Bounded the way every other rules boundary is: a save may
        ...
        private static InvalidDataException Invalid(string field)
            => new InvalidDataException("Historical v8 scalar/collection contract is invalid: " + field + ".");
    }
}
