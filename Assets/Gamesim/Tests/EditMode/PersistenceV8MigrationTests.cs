...
namespace Gamesim.Tests.EditMode
{
    ...
    public sealed class PersistenceV8MigrationTests
    {
        ...
        {
            Assert.That(ContentCatalog.Create(11u).schemaVersion, Is.EqualTo(9));
            Assert.That(SeasonBuilder.Create(new SeasonBuilder.Choice(), 11u).schemaVersion, Is.EqualTo(9));
        }
        ...
        public void AV7SaveOnDiskLoadsUnchangedAndOnlyRewritesOnAnExplicitSave()
        {
            ...
            Assert.That(message, Does.Contain("Schema 7").And.Contain("schema 9 in memory"));
        ...
        {
            var payload = PersistenceMigrationTests.StripSchema8(PersistenceMigrationTests.StripSchema9(Capture(state)));
