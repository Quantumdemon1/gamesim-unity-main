...
namespace Gamesim.Tests.EditMode
{
    ...
    public sealed class PersistenceV7MigrationTests
    {
        ...
        public void AV6SaveOnDiskLoadsUnchangedAndOnlyRewritesOnAnExplicitSave()
        {
            ...
            Assert.That(message, Does.Contain("Schema 6").And.Contain("schema 13 in memory"));
            ...
            Assert.That(again.schemaVersion, Is.EqualTo(13));
        ...
        {
            var payload = PersistenceMigrationTests.StripCardCopy(PersistenceMigrationTests.StripSchema8(PersistenceMigrationTests.StripSchema9(PersistenceMigrationTests.StripSchema10(PersistenceMigrationTests.StripSchema11(PersistenceMigrationTests.StripSchema12(Capture(state)))))));
