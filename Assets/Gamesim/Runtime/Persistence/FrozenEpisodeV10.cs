...
{
    /// <summary>
    /// Recursive schema-10 persistence shape, frozen the moment schema 11 was cut.
    ///
    /// <para>Schema 10 is v9 plus deals — the <c>deals</c> list and its <c>dealRulesStartWeek</c>
    /// boundary, which let houseguests start striking bargains without handing a season already
    /// under way a system it was not played under.</para>
    ///
    ...
    /// </summary>
    internal static class FrozenEpisodeV10
    {
...
#pragma warning restore 0649
        ...
        {
            if (original == null || original["schemaVersion"]?.Type != JTokenType.Integer || (long)original["schemaVersion"] != 10)
                throw new InvalidDataException("Expected simulation schema version 10.");
